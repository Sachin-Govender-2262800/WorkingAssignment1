    ...
    return (
      <div className = "PixMain">
          <div className='header'>
              <h1>Chimpanzee Blur Challenge </h1>
              <p>The tiger as inspired from JJsmooth44's work is estimated at 172700 and 299700 being left in the wild. Therefore the Pixel Maker is blurred at 3px.
